...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__nav__option">
            <a href="#" class="search-switch"><img src="{{ asset('malefashion-master') }}/img/icon/search.png"
                    alt=""></a>
            <a href="#"><img src="{{ asset('malefashion-master') }}/img/icon/heart.png" alt=""></a>
            <a href="#"><img src="{{ asset('malefashion-master') }}/img/icon/cart.png" alt="">
                <span>0</span></a>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="{{ asset('malefashion-master') }}/img/logo.png"
                                alt=""></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        ...
                        <a href="#"><img src="{{ asset('malefashion-master') }}/img/icon/heart.png"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('malefashion-master') }}/img/icon/cart.png"
                                alt=""> <span>0</span></a>
                        <div class="price">$0.00</div>
                    </div>
                </div>
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/product/product-1.jpg">
                            ...
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('malefashion-master') }}/img/icon/heart.png"
                                            alt=""></a></li>
                                <li><a href="#"><img
                                            src="{{ asset('malefashion-master') }}/img/icon/compare.png"
                                            alt="">
                                        <span>Compare</span></a></li>
                                <li><a href="#"><img
                                            src="{{ asset('malefashion-master') }}/img/icon/search.png"
                                            alt=""></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="{{ asset('malefashion-master') }}/img/icon/calendar.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="{{ asset('malefashion-master') }}/img/footer-logo.png"
                                    alt=""></a>
                        </div>
                        <p>The customer is at the heart of our unique business model, which includes design.</p>
                        <a href="#"><img src="{{ asset('malefashion-master') }}/img/payment.png"
                                alt=""></a>
                    </div>
                </div>
