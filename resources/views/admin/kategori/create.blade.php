...
@section('main')
    <div class="container-fluid">
        <form action="{{ route('admin.kategori.store') }}" method="POST" id="form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" class="form-control" style="width: 20px; height: 20px;"
                                        id="is_parent" name="is_parent" placeholder="is_parent" checked />
                                </div>
                            </div>

                            <div class="form-group row show_parent" style="display: none;">
